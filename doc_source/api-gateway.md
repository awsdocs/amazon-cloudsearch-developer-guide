...
1. Choose **Create API** \(or choose **Get Started** if this is your first time using API Gateway\)\.

1. Choose **Build** under **REST API** \(not private\)\.

1. Provide a name and optional description, then choose **Create API**\.

1. Choose **Actions**, **Create Method**\. From the dropdown menu, choose **GET** and confirm\.
