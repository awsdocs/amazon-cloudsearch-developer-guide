...
To learn more about the benefits of API Gateway, see the [API Gateway Developer Guide](http://docs.aws.amazon.com/apigateway/latest/developerguide/)\.
